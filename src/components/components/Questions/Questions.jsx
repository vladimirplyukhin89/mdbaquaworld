      ...
      <MDBAccordion flush initialActive={1} className="p-5 questions__wrapper">
        ...
        <MDBAccordionItem
          ...
          <p>
            ...
            природных подземных, надземных вод разной степени загрязненности до
            норм качества питьевой воды или иных требований.
          </p>
        </MDBAccordionItem>
        <MDBAccordionItem
          collapseId={3}
          ...
          <p>
            ...
            проектно-строительные работы при возведении водоочистных комплексов.{" "}
            <br />
            Станции собираются на базе металлоконструкций с сэндвич-панелями по
            размеру стандартных транспортабельных блоков. Исполнение станций
            может быть адаптировано для эксплуатации, как в жарком климате, так
            и в условиях крайнего севера. Все контейнерные станции соответствуют
            нормам пожаробезопасности и сделаны в антивандальном исполнении. Так
            же могут быть дополнены отдельным контейнером с системой хранения и
            раздачи чистой воды.
          </p>
        </MDBAccordionItem>
      </MDBAccordion>
