      ...
      <MDBAccordion flush initialActive={1} className="p-5 questions__wrapper">
        <MDBRipple className="w-100">
          <MDBAccordionItem
            ...
            <p>
              - Воинские части, аванпосты, базы и временные базы, подразделения
              МЧС и зоны стихийных бедствий.
            </p>
          </MDBAccordionItem>
        </MDBRipple>
        <MDBRipple className="w-100">
        ...
        <MDBRipple className="w-100">
          <MDBAccordionItem
            ...
            <p>
              ...
              отсутствие блочно-модульного здания, а сами установки смонтированы
              на раме с возможностью модульной сборки. <br />
